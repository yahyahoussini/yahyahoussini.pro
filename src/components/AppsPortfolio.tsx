...
import { ShoppingCart, BarChart3, Coffee, Scale, Stethoscope, GraduationCap, Building2, Hotel, Dumbbell, Calendar, Users, FolderKanban, UserCog, Package, Bot, Wand2, TrendingUp, Headphones, Workflow, FileSearch, MessageSquare, FileText, Target, PenTool, PieChart } from 'lucide-react';
...
/**
 * AppsPortfolio Component
 * Showcases a grid of application projects with categorization
 * Features hover effects and links to project details
 */
    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-muted/30" ref={ref}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {apps.slice(0, displayCount).map((app, index) => {
            const Icon = app.icon;
            return (
              <motion.div
                key={app.key}
          ...
          >
            <Button
              onClick={() => {
                ...
                setDisplayCount(prev => Math.min(prev + increment, apps.length));
